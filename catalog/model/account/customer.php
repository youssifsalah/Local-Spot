...
class Customer extends \Opencart\System\Engine\Model {
	...
	public function addCustomer(array $data): int {
		...
		if (isset($data['customer_group_id'])) {
			$requested_group_id = (int)$data['customer_group_id'];

			if ($requested_group_id === $seller_group_id) {
				$customer_group_id = $requested_group_id;
			} elseif (is_array($this->config->get('config_customer_group_display')) && in_array($requested_group_id, (array)$this->config->get('config_customer_group_display'))) {
				$customer_group_id = $requested_group_id;
			} else {
