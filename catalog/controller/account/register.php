...
class Register extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['buyer_group_id'] = $this->getBuyerGroupId();
		$data['seller_group_id'] = $this->getSellerGroupId();
		$data['account_type'] = 'buyer';
		$data['customer_group_id'] = $data['buyer_group_id'];
	...
	public function register(): void {
		...
		$account_type = isset($post_info['account_type']) && $post_info['account_type'] === 'seller' ? 'seller' : 'buyer';
		...
		if (!$json) {
			// Customer Group (Buyer/Seller)
			$buyer_group_id = $this->getBuyerGroupId();
			$seller_group_id = $this->getSellerGroupId();
			$customer_group_id = $account_type === 'seller' ? $seller_group_id : $buyer_group_id;
			...
			} elseif ($account_type !== 'seller' && !in_array($customer_group_id, (array)$this->config->get('config_customer_group_display'))) {
				$json['error']['warning'] = $this->language->get('error_customer_group');
			}
	...
	private function getBuyerGroupId(): int {
		$seller_name = 'Buyer';
