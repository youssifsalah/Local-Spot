...
$csvPath = 'c:/Users/Youssif/Desktop/starnine/starnine_scraper/data/basiclook_fashion.csv';
...
function downloadImage(string $url, string $sku, string $root): string {
    ...
    $dir = $root . '/image/catalog/basiclook';
    if (!is_dir($dir)) {
        mkdir($dir, 0777, true);
    }
    ...
    return file_exists($full) ? ('catalog/basiclook/' . $filename) : '';
}
...
echo "Inserted=$inserted Updated=$updated Skipped=$skipped BasiclookCategoryID=$brand_id BasiclookProducts=$count" . PHP_EOL;
