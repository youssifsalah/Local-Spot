...
$csvPath = 'c:/Users/Youssif/Desktop/starnine/starnine_scraper/data/kntd_fashion.csv';
...
function downloadImage(string $url, string $sku, string $root): string {
    ...
    return file_exists($full) ? ('catalog/kntd/' . $filename) : '';
}
...
echo "Inserted=$inserted Updated=$updated Skipped=$skipped KNTDCategoryID=$brand_id KNTDProducts=$count" . PHP_EOL;
