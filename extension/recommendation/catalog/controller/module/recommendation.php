<?php
namespace Opencart\Catalog\Controller\Extension\Recommendation\Module;
...
class Recommendation extends \Opencart\System\Engine\Controller {
    ...
    public function index(array $setting = []): string {
        ...
        $this->document->addStyle('catalog/view/stylesheet/recommendation.css');
        $this->document->addScript('catalog/view/javascript/recommendation.js');
        ...
        return $this->load->view('extension/recommendation/module/recommendation', $data);
    }
}
